...
var obstacle_scenes := {
	"jump": preload("res://Obstacles/bar_horizontal.tscn"),
	"wall": preload("res://Obstacles/wall.tscn"),
	"slide": preload("res://Obstacles/bar_horizontal.tscn")
}
